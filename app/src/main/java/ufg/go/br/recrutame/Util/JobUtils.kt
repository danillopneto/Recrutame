...
class JobUtils {
    companion object{
        fun getJobs():List<JobModel>{
            ...
            jobs.add(JobModel("Desenvolvedor de software C#", "http://www.e-farsas.com/wp-content/uploads/google-fachada.jpg", "Goiânia - GO", "CLT",3000.0, "Desenvolver sistemas web com ASP.NET Core.", "LG" ));
            jobs.add(JobModel("Desenvolvedor de software Java", "http://t.i.uol.com.br/tecnologia/2012/01/20/fachada-da-boate-facebook-inaugurada-nesta-sexta-em-epitaciolandia-1327101786423_615x300.jpg", "Goiânia - GO", "CLT",3000.0, "Desenvolver sistemas web com tecnologia Java.", "TOTVS"));
            ...
            jobs.add(JobModel("Gerente de loja", "hhttp://www.bestofsampleresume.com/wp-content/uploads/2016/07/retail-store-manager-resume-sample.jpg", "Goiânia - GO", "CLT",3000.0, "Gerenciar a maior loja de produtos naturais de Goiânia.", "Natureba"));
